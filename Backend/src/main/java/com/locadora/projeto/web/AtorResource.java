...
public class AtorResource {
    ...
    public ResponseEntity<List<DropdownDTO>> buscarElencoFilme(@PathVariable("idFilme") Integer idFilme){
        List<DropdownDTO> listaAtores = service.searchCastMovie(idFilme);
